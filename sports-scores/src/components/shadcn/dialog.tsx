...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn(
        "cn-font-heading text-base font-medium leading-none",
        className,
      )}
      {...props}
    />
...
function DialogDescription({
  ...
  return (
    <DialogPrimitive.Description
      ...
      className={cn(
        "[a]:*:underline [a]:*:underline-offset-3 hover:[a]:*:text-foreground text-sm text-muted-foreground",
        className,
      )}
      {...props}
    />
