...
export default function ScoreSummaryCard({matchDetails, homeDetails, awayDetails}: ScoreSummaryCardProps) {
    // console.log(matchDetails);
    return (<Link href="/misc/coming">
        <div className="border border-gray-300 min-h-[100px] flex flex-col mt-4 items-center justify-center p-4">
            ...
            <div className='grid grid-cols-5 gap-2 mt-2'> 
                ...
                <div className='content-center'><Image src={awayDetails?.img} width={48} height={48} alt="Away team image"/></div>
                <p className="text-left	col-span-2 text-sm text-gray-700">{homeDetails.name}</p>
                <div></div>
                <p className="text-right col-span-2 text-sm text-gray-700">{awayDetails.name}</p> 
            </div>
